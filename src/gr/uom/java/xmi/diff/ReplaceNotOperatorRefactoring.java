...
public class ReplaceNotOperatorRefactoring  implements Refactoring {
    private final AbstractCall operationBefore;
    private final AbstractCall operationAfter;


    public ReplaceNotOperatorRefactoring(AbstractCall operationBefore,
    ...
    public RefactoringType getRefactoringType() {
        return RefactoringType.REPLACE_NOT_OPERATOR;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ReplaceNotOperatorRefactoring other = (ReplaceNotOperatorRefactoring) obj;
