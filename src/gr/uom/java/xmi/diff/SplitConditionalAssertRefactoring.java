...
public class SplitConditionalAssertRefactoring implements Refactoring {
    private final AbstractCall operationBefore;
    private final AbstractCall operationAfter;


    public SplitConditionalAssertRefactoring(AbstractCall operationBefore,
    ...
    public RefactoringType getRefactoringType() {
        return RefactoringType.SPLIT_CONDITIONAL_ASSERT;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SplitConditionalAssertRefactoring other = (SplitConditionalAssertRefactoring) obj;
